package com.example.sensoresfirebase.ui.main;
...
public class PlaceholderFragment extends Fragment {
    ...
    public static Fragment newInstance(int index) {
        ...
        switch (index){
            case 1: fragment = new InicioFragment();
                break;
            case 2: fragment = new UsoSensoresFragment();
                break;
            case 3: fragment = new FormularioFragment();
                break;
        }
